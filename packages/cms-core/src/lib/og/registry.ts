...
export const OG_TARGETS: OgTarget[] = [
  ...
  collection<Series>("series", { folderName: DEFAULT_OG_FOLDER_NAME }),
  global<CvPage>("cv-page", { folderName: DEFAULT_OG_FOLDER_NAME }),
  global<BlogPage>("blog-page", { folderName: DEFAULT_OG_FOLDER_NAME }),
  global<SeriesPage>("series-page", { folderName: DEFAULT_OG_FOLDER_NAME }),
  global<ProjectsPage>("projects-page", { folderName: DEFAULT_OG_FOLDER_NAME }),
