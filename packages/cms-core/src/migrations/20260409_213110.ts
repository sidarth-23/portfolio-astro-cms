...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_site_settings_sidebar_footer_items_type" AS ENUM('github', 'linkedin', 'email', 'rss', 'facebook', 'twitter', 'dribbble', 'instagram', 'youtube', 'twitch', 'tiktok', 'medium', 'whatsapp', 'telegram', 'discord', 'reddit', 'pinterest', 'behance', 'codepen', 'gitlab', 'stackoverflow', 'devto');
  ...
  CREATE TABLE "_posts_v" (
  	...
  	"version_home_sections_summary" varchar,
  ...
  CREATE TABLE "site_settings_sidebar_footer_items" (
  	...
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"type" "enum_site_settings_sidebar_footer_items_type" NOT NULL,
  ...
  CREATE TABLE "site_settings" (
  	...
  	"route_seo_blog_home_title" varchar NOT NULL,
  	"route_seo_blog_home_description" varchar NOT NULL,
  	"route_seo_blog_home_image_id" integer,
  	"route_seo_blog_series_title" varchar NOT NULL,
  	"route_seo_blog_series_description" varchar NOT NULL,
  	"route_seo_blog_series_image_id" integer,
  	"route_seo_not_found_title" varchar NOT NULL,
  	"route_seo_not_found_description" varchar NOT NULL,
  	"route_seo_not_found_image_id" integer,
  ...
  CREATE TABLE "cv_page_sections_badges" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"value" varchar
  ...
  CREATE INDEX "cv_page_sections_badges_order_idx" ON "cv_page_sections_badges" USING btree ("_order");
  CREATE INDEX "cv_page_sections_badges_parent_id_idx" ON "cv_page_sections_badges" USING btree ("_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "cv_page_sections_badges" CASCADE;
