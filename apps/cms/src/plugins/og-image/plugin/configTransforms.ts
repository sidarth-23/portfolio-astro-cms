...
export function injectSeoButtons(
  ...
  if (mode === "draft-and-publish") {
    editComponents["PublishButton"] = makeEntry("./plugins/og-image/ui#SeoPublishButton");
    editComponents["SaveDraftButton"] = makeEntry("./plugins/og-image/ui#SeoSaveDraftButton");
  } else {
    editComponents["SaveButton"] = makeEntry("./plugins/og-image/ui#SeoSaveButton");
  }
