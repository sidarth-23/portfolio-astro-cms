...
type UploadThemeConfig = {
  frameClass?: string;
  frameStyle?: string;
};

export function createUpload(config: UploadThemeConfig) {
  return function Upload({ doc, alt, captionHtml, mediaBaseUrl }: UploadProps) {
    ...
    return (
      <figure class="image-figure">
        <div class={config.frameClass} style={config.frameStyle}>
